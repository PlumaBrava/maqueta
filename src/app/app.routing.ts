...
export const routes: Routes = [
  {
    ...
    children:[
      ...
      { path: 'a', loadChildren: './pages/dashboard/dashboard.module#DashboardModule', data: { breadcrumb: 'Dashboard' }  },          
      ...
      { path: 'users', loadChildren: './maqueta/users/users.module#UsersModule', data: { breadcrumb: 'Usuarios' }  },         
      { path: 'blank', component: BlankComponent, data: { breadcrumb: 'Blank page' } },
      { path: 'search', component: SearchComponent, data: { breadcrumb: 'Search' } }
    ]
  },
  // { path: 'login', loadChildren: './pages/login/login.module#LoginModule' },
  { path: 'login', loadChildren: './maqueta/users/users.module#UsersModule' },
